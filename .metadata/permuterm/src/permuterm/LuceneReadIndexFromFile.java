...
//                       System.out.println("Splitted String: " + list);
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        if(count == 1){
         ...
         while(match_iterator.hasNext()) {
        	 ...
        	 ArrayList<String> matched = matchString("E:\\\\STUDY\\\\ACADEMIC\\\\5th sem\\\\IR\\\\Project\\\\.metadata\\\\permuterm\\\\outindexedfiles\\\\permu.txt",permuname);
    ...
    private static void searchDocs(String Query) throws Exception
    {
    	...
    	IndexSearcher searcher = createSearcher();
    	ArrayList<String> matched = matchString("E:\\\\STUDY\\\\ACADEMIC\\\\5th sem\\\\IR\\\\Project\\\\.metadata\\\\permuterm\\\\outindexedfiles\\\\permu.txt",Query);
